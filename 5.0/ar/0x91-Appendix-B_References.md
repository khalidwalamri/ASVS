...
من المرجّح أن تكون مشاريع OWASP التالية مفيدة لمستخدمي هذا المعيار ومتبنّيه:

## مشاريع OWASP الأساسية
...
## مشاريع OWASP المتعلقة بإنترنت الأشياء
